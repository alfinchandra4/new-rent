                    ...
                    <div class="page-content page-container" id="page-content" style="margin-top: -50px">
                        <div class="padding">
                            <div class="row row-sm sr">
                                Lorem ipsum dolor sit, amet consectetur adipisicing elit. Vitae adipisci vero omnis odio labore neque quis explicabo maxime repudiandae molestiae, assumenda aliquid atque, nulla mollitia libero deleniti, non quia rerum!
                                @yield('content')
                            </div>
                        </div>
                    </div>
